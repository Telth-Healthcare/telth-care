        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mt-4">
              Earning Potential for Care Managers
            </h2>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                {[
                  ...
                  {
                    label: "Patient Service Incentive",
                    amount: "Per visit / plan",
                    icon: Activity,
                  },
                  {
                    label: "Sales Bonus",
          ...
          <div className="mt-12 max-w-4xl mx-auto">
            <div className="rounded-xl border border-emerald-100 bg-emerald-50 p-6 text-center">
              <p className="text-sm text-slate-600 leading-7">
                ...
                aligning with TELTH's AI-enabled collaborative care and
                community healthcare delivery model.
              </p>
            </div>
          </div>
        </div>
